...
class AjouterRecette extends Component {
    ...
    handleChange = event => { // fonction adaptable pour tous les elements du formulaire.
    ...
    handleSubmit = event => {
        ...
        const recette = { ...this.state } // Au click, on prend l'ensemble du state rempli pour l'ajouter au composant.
